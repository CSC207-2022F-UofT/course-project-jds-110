...
//    a has money of 200 and name of 'MyFarm' and b has money of 100 and name of 'YourFarm'
    ...
    public ArrayList<LeaderboardPlace>getLeaderboard(){
        // add a call to updateLeaderboard with proper attributes
        return standings;
    }

    public void updateLeaderboard(int loadedMoney, String loadedFarmName){
